...
data class AgxParams(
    ...
    val rotation: FloatArray = floatArrayOf(0.2618f, -0.2618f, -0.053f),
    val attenuation: FloatArray = floatArrayOf(50.0f, 50.0f, 30.0f),
    val reverseRotation: FloatArray = floatArrayOf(0.2618f, -0.2618f, -0.053f),
    val purityBoost: FloatArray = floatArrayOf(10.0f, 30.0f, 4.0f),
