    ...
    private fun parsePreset(obj: JSONObject): Preset {
        ...
        return Preset(
            ...
            agxParams = AgxParams(
                ...
                rotation = jsonArrayToFloatArray(p.optJSONArray("rotation"), floatArrayOf(0.2618f, -0.2618f, -0.053f)),
                attenuation = jsonArrayToFloatArray(p.optJSONArray("attenuation"), floatArrayOf(50.0f, 50.0f, 30.0f)),
                reverseRotation = jsonArrayToFloatArray(p.optJSONArray("reverse_rotation"), floatArrayOf(0.2618f, -0.2618f, -0.053f)),
