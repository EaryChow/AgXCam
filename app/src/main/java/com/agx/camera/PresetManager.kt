    ...
    private fun parsePreset(obj: JSONObject): Preset {
        ...
        return Preset(
            ...
            agxParams = AgxParams(
                ...
                rotation = jsonArrayToFloatArray(p.optJSONArray("rotation"), floatArrayOf(0.1222f, -0.1222f, -0.053f)),
                attenuation = jsonArrayToFloatArray(p.optJSONArray("attenuation"), floatArrayOf(45.0f, 50.0f, 30.0f)),
                reverseRotation = jsonArrayToFloatArray(p.optJSONArray("reverse_rotation"), floatArrayOf(0.1222f, -0.1222f, -0.053f)),
                purityBoost = jsonArrayToFloatArray(p.optJSONArray("purity_boost"), floatArrayOf(20.0f, 30.0f, 4.0f)),
